    ...
    if ($username === '' || $email === '' || $password === '' || $konfirm === '') {
        ...
        if ($cekUsername->fetch()) {
            ...
            try {
                ...
                if ($e->getCode() === '23000') {
                    $pesan = 'Username atau email sudah digunakan oleh akun lain.';
                } else {
    ...
    <div class="form-box">
        ...
        <?php if ($sukses): ?>
            <div style="text-align: center; margin-top: 1rem;">
                <a
                    href="login.php"
                    class="btn btn-merah btn-submit"
                >
                    Pergi ke Login
                </a>
            </div>
        <?php else: ?>
            <form method="POST" action="register.php">
                ...
                <div class="form-group">
                    ...
                    <div
                        id="info-password"
                        style="margin-top: 0.4rem; font-size: 0.8rem; color: #aaa;"
                    >
                        Minimal 6 karakter
                    </div>
                    ...
                    <div
                        id="bar-password"
                        style="height: 4px; border-radius: 4px; background: #333; margin-top: 0.3rem; transition: all 0.3s;"
                    >
                        <div
                            id="isi-bar-password"
